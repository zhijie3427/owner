...
import com.hbr.dao.provider.EmployeeDynaSqlProvider;
...
public interface EmployeeMapper {
	...
	@Results({
			@Result(column = "dept_id", property = "dept", one = @One(select = "com.hbr.dao.DeptMapper.selectById", fetchType = FetchType.EAGER)),
			@Result(column = "job_id", property = "job", one = @One(select = "com.hbr.dao.JobMapper.selectById", fetchType = FetchType.EAGER)) })
