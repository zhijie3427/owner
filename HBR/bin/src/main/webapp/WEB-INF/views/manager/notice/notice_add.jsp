...
<body>
	<div id="big">
		...
		<div id="content">
			...
			<div id="right">
				<div id="right_title">当前位置:公告管理>添加公告</div>
				<div id="right_add">
					<f:form action="notice/noticeAdd" method="post" modelAttribute="notice" id="notice_form">
						<div class="add_item">
							<label>公告标题:</label><input type="text" name="title" id="title"/><f:errors path="title" cssClass="error"/>
						</div>
