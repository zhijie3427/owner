...
<body>
	<div id="big">
		...
		<div id="content">
			...
			<div id="right">
				<div id="right_title">当前位置:员工管理>员工信息修改</div>
				<div id="right_add">
					<f:form action="employee/emloyeeModify" method="post" modelAttribute="employee" id="employee_form">
						<div class="add_item">
							<label>姓名:</label><f:input path="name" /><f:errors path="name" cssClass="error"/>
						</div>
						<div class="add_item">
							<label>身份证号:</label><f:input path="cardId" /><f:errors path="cardId" cssClass="error"/>
						</div>
						<div class="add_item">
							<label>性别:</label>
							<select name="sex">
						...
						<div class="add_item">
							<label>年龄:</label><f:input path="age" /><f:errors path="age" cssClass="error"/>
						</div>
						<div class="add_item">
							<label>职位:</label>
							<select name="jobId">
						...
						<div class="add_item">
							<label>邮箱:</label><f:input path="email" /><f:errors path="email" cssClass="error"/>
						</div>
						<div class="add_item">
							<label>QQ:</label><f:input path="qq" /><f:errors path="qq" cssClass="error"/>
						</div>
						<div class="add_item">
							<label>民族:</label>
							<select name="race">
						...
						<div class="add_item">
							<label>联系地址:</label><f:input path="address" /><f:errors path="address" cssClass="error"/>
						</div>
						<div class="add_item">
							<label>爱好:</label><f:input path="hobby"/><f:errors path="hobby" cssClass="error"/>
						</div>
						<div class="add_item">
							<label>邮政编码:</label><f:input path="postCode" />
						</div>
						<div class="add_item">
							<label>所属部门:</label>
							<select name="deptId">
						...
						<div class="add_item">
							<label>备注:</label><f:input path="remark" />
						</div>
						<div id="add_submit">
